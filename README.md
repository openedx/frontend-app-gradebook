...
### What does this offer over the stock LMS Gradebook?

![A screenshot of the grade listings](documentation/screenshots/grade-listings.png)

The MFE offers a great deal more granularity when searching for problems, an easy interface for editing grades, an 
...
### What does the LMS Gradebook offer that this project does not?
...
link for the LMS gradebook reports that "this feature is available only to courses with a small number of enrolled 
...
to the problem in question will have a worse UX than the LMS gradebook provides. Instructors that rely on the graphs
