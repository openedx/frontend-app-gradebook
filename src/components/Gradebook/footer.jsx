        ...
        <div className="max-width-1180 d-grid">
          ...
          <div className="area-5">
            <ul className="d-flex flex-row justify-content-between list-unstyled max-width-222 mb-4">
              ...
              <li><a href="https://twitter.com/edXOnline" title="Twitter" rel="noreferrer" target="_blank">
                <Icon className={['fa', 'fa-twitter-square', 'fa-2x']} screenReaderText="Follow edX on Twitter" />
              </a></li>
              <li><a href="https://www.youtube.com/user/edxonline" title="Youtube" rel="noreferrer" target="_blank">
                <Icon className={['fa', 'fa-youtube-square', 'fa-2x']} screenReaderText="Subscribe to the edX YouTube channel" />
              </a></li>
              <li><a href="https://www.linkedin.com/company/edx" title="LinkedIn" rel="noreferrer" target="_blank">
                <Icon className={['fa', 'fa-linkedin-square', 'fa-2x']} screenReaderText="Follow edX on LinkedIn" />
              </a></li>
              <li><a href="https://plus.google.com/+edXOnline" title="Google+" rel="noreferrer" target="_blank">
