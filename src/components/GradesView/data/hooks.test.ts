...
describe('GradesView/data hooks', () => {
  ...
  describe('useRefetchGrades', () => {
    it('clears the page cursor AND invalidates when one is set', () => {
      ...
      // Invalidation is required even when the key change triggers a fetch of the
      // base page: a still-fresh cached base page would otherwise be served with
      // the pre-change filters.
