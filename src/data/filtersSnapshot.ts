...
/**
 * Synchronous mirror of the `FiltersProvider` filter values, read by the grades
 * queryFn at fetch time. The grade-limit values mirror the APPLIED limits (they
 * are only committed on apply/reset), not the live input values.
 */
