 ...
 *
 * Replaces the non-filter UI bits of the old Redux `app` and `grades` slices:
 * grade format toggle, success banner, import toast, active view, filter-menu
 * open/transition, modal state, pagination cursor, and CSV-upload feedback.
 */
